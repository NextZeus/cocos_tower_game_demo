...
var GPPassLayer = cc.LayerColor.extend({
    ...
    loadButton : function(){
        var nextNormal    = new cc.Sprite("#ui_btnNext.png");
        var nextSelected  = new cc.Sprite("#ui_btnNext.png");
        var nextDisabled  = new cc.Sprite("#ui_btnNext.png");
        ...
        var next = new cc.MenuItemSprite(
            ...
            function(){
                ...
                var nextLevel = parseInt(levelStr);
        ...
        var backNormal    = new cc.Sprite("#ui_btnBack.png");
        var backSelected  = new cc.Sprite("#ui_btnBack.png");
        var backDisabled  = new cc.Sprite("#ui_btnBack.png");
